...
<!-- Mirrored from new.axilthemes.com/demo/template/blogar/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Oct 2023 13:53:46 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>{{env('APP_NAME')}} - {{env('APP_DESCRIPTION')}}</title>
    <meta name="robots" content="{.env('APP_DESCRIPTION')}">
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{asset('blog_assets/css/vendor/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('blog_assets/css/vendor/font-awesome.css')}}">
    <link rel="stylesheet" href="{{asset('blog_assets/css/vendor/slick.css')}}">
    <link rel="stylesheet" href="{{asset('blog_assets/css/vendor/slick-theme.css')}}">
    <link rel="stylesheet" href="{{asset('blog_assets/css/vendor/base.css')}}">
    <link rel="stylesheet" href="{{asset('blog_assets/css/plugins/plugins.css')}}">
            ...
            <div class="header-wrap">
                <div class="row justify-content-between align-items-center">
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-3 col-12">
                        <div class="logo">
                            <a href="index.html">
                                <img class="dark-logo" src="blog_assets/images/logo/logo-black.png" alt="Blogar logo">
                                <img class="light-logo" src="blog_assets/images/logo/logo-white2.png" alt="Blogar logo">
                            </a>
                        </div>
                    </div>
                                                                    ...
                                                                    <div class="content-block image-rounded">
                                                                        <div class="post-thumbnail mb--20">
                                                                            <a href="post-details.html">
                                                                                <img class="w-100" src="blog_assets/images/others/mega-post-01.jpg" alt="Post Images">
                                                                            </a>
                                                                        </div>
                                                            ...
                                                            <span data-text="DESIGN">DESIGN</span>
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="content-block image-rounded">
                                                                        <div class="post-thumbnail mb--20">
                                                                            <a href="post-details.html">
                                                                                <img class="w-100" src="blog_assets/images/others/mega-post-02.jpg" alt="Post Images">
                                                                            </a>
                                                                        </div>
                                                                        <div class="post-content">
                                                                            <div class="post-cat">
                                                            ...
                                                            <span data-text="CREATIVE">CREATIVE</span>
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="content-block image-rounded">
                                                                        <div class="post-thumbnail mb--20">
                                                                            <a href="post-details.html">
                                                                                <img class="w-100" src="blog_assets/images/others/mega-post-03.jpg" alt="Post Images">
                                                                            </a>
                                                                        </div>
                                                                        <div class="post-content">
                                                                            <div class="post-cat">
                                                            ...
                                                            <span data-text="TRAVEL">TRAVEL</span>
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="content-block image-rounded">
                                                                        <div class="post-thumbnail mb--20">
                                                                            <a href="post-details.html">
                                                                                <img class="w-100" src="blog_assets/images/others/mega-post-04.jpg" alt="Post Images">
                                                                            </a>
                                                                        </div>
                                                                        <div class="post-content">
                                                                            <div class="post-cat">
                    ...
                    <div class="col-xl-3 col-lg-8 col-md-8 col-sm-9 col-12">
                        <div class="header-search text-end d-flex align-items-center">
                            ...
                            <ul class="metabar-block">
                                ...
                                <li><a href="#"><img src="blog_assets/images/others/author.png" alt="Author Images"></a></li>
                            </ul>
        ...
        <div class="popup-mobilemenu-area">
            <div class="inner">
                <div class="mobile-menu-top">
                    <div class="logo">
                        <a href="index.html">
                            <img class="dark-logo" src="blog_assets/images/logo/logo-black.png" alt="Logo Images">
                            <img class="light-logo" src="blog_assets/images/logo/logo-white2.png" alt="Logo Images">
                        </a>
                    </div>
                            ...
                            <div class="slider-activation axil-slick-arrow">
                                ...
                                <div class="content-block">
                                    ...
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="blog_assets/images/post-images/gallery-post-01.jpg" alt="Post Images">
                                        </a>
                                    </div>
                                    <!-- End Post Thumbnail  -->
                                        ...
                                        <div class="post-meta-wrapper with-button">
                                            <div class="post-meta">
                                                <div class="post-author-avatar border-rounded">
                                                    <img src="blog_assets/images/post-images/author/author-image-3.png" alt="Author Images">
                                                </div>
                                                <div class="content">
                                ...
                                <div class="content-block">
                                    ...
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="blog_assets/images/post-images/gallery-post-03.jpg" alt="Post Images">
                                        </a>
                                    </div>
                                    <!-- End Post Thumbnail  -->
                                    <!-- Start Post Content  -->
                                    <div class="post-content">
                                        ...
                                        <div class="post-meta-wrapper with-button">
                                            <div class="post-meta">
                                                <div class="post-author-avatar border-rounded">
                                                    <img src="blog_assets/images/post-images/author/author-image-1.png" alt="Author Images">
                                                </div>
                                                <div class="content">
                                                    <h6 class="post-author-name">
                                                        <a class="hover-flip-item-wrapper" href="author.html">
                                ...
                                <div class="content-block">
                                    ...
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="blog_assets/images/post-images/gallery-post-02.jpg" alt="Post Images">
                                        </a>
                                    </div>
                                    <!-- End Post Thumbnail  -->
                                    <!-- Start Post Content  -->
                                    <div class="post-content">
                                        ...
                                        <div class="post-meta-wrapper with-button">
                                            <div class="post-meta">
                                                <div class="post-author-avatar border-rounded">
                                                    <img src="blog_assets/images/post-images/author/author-image-2.png" alt="Author Images">
                                                </div>
                                                <div class="content">
                                                    <h6 class="post-author-name">
                                                        <a class="hover-flip-item-wrapper" href="author.html">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-xl-6 col-md-12 col-12 mt--30">
                        <div class="content-block content-direction-column axil-control is-active post-horizontal thumb-border-rounded">
                            ...
                            <div class="post-thumbnail">
                                <a href="post-details.html">
                                    <img src="blog_assets/images/post-images/post-images-1.jpg" alt="Post Images">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-xl-6 col-md-12 col-12 mt--30">
                        <div class="content-block content-direction-column axil-control post-horizontal  thumb-border-rounded">
                            ...
                            <div class="post-thumbnail">
                                <a href="post-details.html">
                                    <img src="blog_assets/images/post-images/post-images-2.jpg" alt="Post Images">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="axil-banner mb--30">
                                <div class="thumbnail">
                                    <a href="#">
                                        <img class="w-100" src="blog_assets/images/add-banner/banner-03.png" alt="Banner Images">
                                    </a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="modern-post-activation slick-layout-wrapper axil-slick-arrow arrow-between-side">
                                        ...
                                        <div class="slick-single-layout">
                                            <div class="content-block modern-post-style text-center content-block-column">
                                                ...
                                                <div class="post-thumbnail">
                                                    <a href="post-details.html">
                                                        <img src="blog_assets/images/post-images/post-column-04.jpg" alt="Post Images">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="slick-single-layout">
                                            <div class="content-block modern-post-style text-center content-block-column">
                                                ...
                                                <div class="post-thumbnail">
                                                    <a href="post-details.html">
                                                        <img src="blog_assets/images/post-images/post-column-05.jpg" alt="Post Images">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="slick-single-layout">
                                            <div class="content-block modern-post-style text-center content-block-column">
                                                ...
                                                <div class="post-thumbnail">
                                                    <a href="post-details.html">
                                                        <img src="blog_assets/images/post-images/post-column-06.jpg" alt="Post Images">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="slick-single-layout">
                                            <div class="content-block modern-post-style text-center content-block-column">
                                                ...
                                                <div class="post-thumbnail">
                                                    <a href="post-details.html">
                                                        <img src="blog_assets/images/post-images/post-column-07.jpg" alt="Post Images">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modern-post-activation slick-layout-wrapper axil-slick-arrow arrow-between-side">
                                        ...
                                        <div class="slick-single-layout">
                                            <div class="content-block modern-post-style text-center content-block-column">
                                                ...
                                                <div class="post-thumbnail">
                                                    <a href="post-details.html">
                                                        <img src="blog_assets/images/post-images/post-column-08.jpg" alt="Post Images">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="slick-single-layout">
                                            <div class="content-block modern-post-style text-center content-block-column">
                                                ...
                                                <div class="post-thumbnail">
                                                    <a href="post-details.html">
                                                        <img src="blog_assets/images/post-images/post-column-01.jpg" alt="Post Images">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="slick-single-layout">
                                            <div class="content-block modern-post-style text-center content-block-column">
                                                ...
                                                <div class="post-thumbnail">
                                                    <a href="post-details.html">
                                                        <img src="blog_assets/images/post-images/post-column-02.jpg" alt="Post Images">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modern-post-activation slick-layout-wrapper axil-slick-arrow arrow-between-side">
                                        ...
                                        <div class="slick-single-layout">
                                            <div class="content-block modern-post-style text-center content-block-column">
                                                ...
                                                <div class="post-thumbnail">
                                                    <a href="post-details.html">
                                                        <img src="blog_assets/images/post-images/post-column-03.jpg" alt="Post Images">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="list-categories d-flex flex-wrap">
                            ...
                            <div class="single-cat">
                                <div class="inner">
                                    <a href="#">
                                        <div class="thumbnail">
                                            <img src="blog_assets/images/post-images/post-sm-01.jpg" alt="post categories images">
                                        </div>
                                        <div class="content">
                            ...
                            <div class="single-cat">
                                <div class="inner">
                                    <a href="#">
                                        <div class="thumbnail">
                                            <img src="blog_assets/images/post-images/post-sm-02.jpg" alt="post categories images">
                                        </div>
                                        <div class="content">
                            ...
                            <div class="single-cat">
                                <div class="inner">
                                    <a href="#">
                                        <div class="thumbnail">
                                            <img src="blog_assets/images/post-images/post-sm-03.jpg" alt="post categories images">
                                        </div>
                                        <div class="content">
                            ...
                            <div class="single-cat">
                                <div class="inner">
                                    <a href="#">
                                        <div class="thumbnail">
                                            <img src="blog_assets/images/post-images/post-sm-04.jpg" alt="post categories images">
                                        </div>
                                        <div class="content">
                            ...
                            <div class="single-cat">
                                <div class="inner">
                                    <a href="#">
                                        <div class="thumbnail">
                                            <img src="blog_assets/images/post-images/post-sm-05.jpg" alt="post categories images">
                                        </div>
                                        <div class="content">
                            ...
                            <div class="single-cat">
                                <div class="inner">
                                    <a href="#">
                                        <div class="thumbnail">
                                            <img src="blog_assets/images/post-images/post-sm-06.jpg" alt="post categories images">
                                        </div>
                                        <div class="content">
                            ...
                            <div class="row trend-tab-content tab-pane fade show active" id="trendone" role="tabpanel" aria-labelledby="trend-one">
                                <div class="col-lg-8">
                                    ...
                                    <div class="content-block trend-post post-order-list axil-control">
                                        ...
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="blog_assets/images/post-images/trend-post-01.jpg" alt="Post Images">
                                            </a>
                                        </div>
                                    </div>
                                    <!-- End Single Post  -->
                                    ...
                                    <div class="content-block trend-post post-order-list is-active">
                                        ...
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="blog_assets/images/post-images/trend-post-02.jpg" alt="Post Images">
                                            </a>
                                        </div>
                                    </div>
                                    <!-- End Single Post  -->
                                    ...
                                    <div class="content-block trend-post post-order-list axil-control">
                                        ...
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="blog_assets/images/post-images/trend-post-03.jpg" alt="Post Images">
                                            </a>
                                        </div>
                                    </div>
                                    <!-- End Single Post  -->
                                    ...
                                    <div class="content-block trend-post post-order-list axil-control">
                                        ...
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="blog_assets/images/post-images/trend-post-04.jpg" alt="Post Images">
                                            </a>
                                        </div>
                                    </div>
                                    <!-- End Single Post  -->
                                ...
                                <div class="row">
                                    <div class="col-xl-7 col-lg-7 col-md-12 col-12">
                                        ...
                                        <div class="content-block post-grid post-grid-large mt--30">
                                            <div class="post-thumbnail">
                                                <a href="post-details.html">
                                                    <img src="blog_assets/images/post-images/post-grid-01.jpg" alt="Post Images">
                                                </a>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-6 col-12">
                                                ...
                                                <div class="content-block post-grid mt--30">
                                                    <div class="post-thumbnail">
                                                        <a href="post-details.html">
                                                            <img src="blog_assets/images/post-images/post-grid-07.jpg" alt="Post Images">
                                                        </a>
                                                    </div>
                                                    <div class="post-grid-content">
                                                        <div class="post-content">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-6 col-12">
                                                ...
                                                <div class="content-block post-grid mt--30">
                                                    <div class="post-thumbnail">
                                                        <a href="post-details.html">
                                                            <img src="blog_assets/images/post-images/post-grid-08.jpg" alt="Post Images">
                                                        </a>
                                                    </div>
                                                    <div class="post-grid-content">
                                                        <div class="post-content">
                                ...
                                <div class="row">
                                    <div class="col-xl-7 col-lg-7 col-md-12 col-12">
                                        ...
                                        <div class="content-block post-grid post-grid-large mt--30">
                                            <div class="post-thumbnail">
                                                <a href="post-details.html">
                                                    <img src="blog_assets/images/post-images/post-grid-09.jpg" alt="Post Images">
                                                </a>
                                            </div>
                                            <div class="post-grid-content">
                                                <div class="post-content">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-6 col-12">
                                                ...
                                                <div class="content-block post-grid mt--30">
                                                    <div class="post-thumbnail">
                                                        <a href="post-details.html">
                                                            <img src="blog_assets/images/post-images/post-grid-02.jpg" alt="Post Images">
                                                        </a>
                                                    </div>
                                                    <div class="post-grid-content">
                                                        <div class="post-content">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-6 col-12">
                                                ...
                                                <div class="content-block post-grid mt--30">
                                                    <div class="post-thumbnail">
                                                        <a href="post-details.html">
                                                            <img src="blog_assets/images/post-images/post-grid-03.jpg" alt="Post Images">
                                                        </a>
                                                    </div>
                                                    <div class="post-grid-content">
                                                        <div class="post-content">
                ...
                <div class="row">
                    <div class="col-lg-8 col-xl-8">
                        <div class="axil-banner">
                            <div class="thumbnail">
                                <a href="#">
                                    <img class="w-100" src="blog_assets/images/add-banner/banner-01.png" alt="Banner Images">
                                </a>
                            </div>
                        </div>
                        <!-- Start Post List  -->
                        <div class="content-block post-list-view axil-control is-active mt--30">
                            <div class="post-thumbnail">
                                <a href="post-details.html">
                                    <img src="blog_assets/images/post-images/post-list-11.jpg" alt="Post Images">
                                </a>
                            </div>
                            <div class="post-content">
                                <div class="post-cat">
                        ...
                        <div class="content-block post-list-view axil-control mt--30">
                            <div class="post-thumbnail">
                                <a href="post-details.html">
                                    <img src="blog_assets/images/post-images/post-list-12.jpg" alt="Post Images">
                                </a>
                            </div>
                            <div class="post-content">
                                <div class="post-cat">
                        ...
                        <div class="content-block post-list-view axil-control mt--30">
                            <div class="post-thumbnail">
                                <a href="post-details.html">
                                    <img src="blog_assets/images/post-images/post-list-15.jpg" alt="Post Images">
                                </a>
                            </div>
                            <div class="post-content">
                                <div class="post-cat">
                        ...
                        <div class="content-block post-list-view axil-control mt--30">
                            <div class="post-thumbnail">
                                <a href="post-details.html">
                                    <img src="blog_assets/images/post-images/post-list-13.jpg" alt="Post Images">
                                </a>
                            </div>
                            <div class="post-content">
                                <div class="post-cat">
                        ...
                        <div class="content-block post-list-view axil-control mt--30">
                            <div class="post-thumbnail">
                                <a href="post-details.html">
                                    <img src="blog_assets/images/post-images/post-list-14.jpg" alt="Post Images">
                                </a>
                            </div>
                            <div class="post-content">
                                <div class="post-cat">
                            ...
                            <div class="axil-single-widget widget widget_categories mb--30">
                                <ul>
                                    <li class="cat-item">
                                        <a href="#" class="inner">
                                            <div class="thumbnail">
                                                <img src="blog_assets/images/post-images/category-image-01.jpg" alt="">
                                            </div>
                                            <div class="content">
                                    ...
                                    <li class="cat-item">
                                        <a href="#" class="inner">
                                            <div class="thumbnail">
                                                <img src="blog_assets/images/post-images/category-image-02.jpg" alt="">
                                            </div>
                                            <div class="content">
                                    ...
                                    <li class="cat-item">
                                        <a href="#" class="inner">
                                            <div class="thumbnail">
                                                <img src="blog_assets/images/post-images/category-image-03.jpg" alt="">
                                            </div>
                                            <div class="content">
                                                <h5 class="title">Travel</h5>
                                            </div>
                                    ...
                                    <li class="cat-item">
                                        <a href="#" class="inner">
                                            <div class="thumbnail">
                                                <img src="blog_assets/images/post-images/category-image-04.jpg" alt="">
                                            </div>
                                            <div class="content">
                            ...
                            <div class="axil-single-widget widget widget_postlist mb--30">
                                ...
                                <div class="post-medium-block">
                                    ...
                                    <div class="content-block post-medium mb--20">
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="blog_assets/images/small-images/blog-sm-01.jpg" alt="Post Images">
                                            </a>
                                        </div>
                                        <div class="post-content">
                                    ...
                                    <div class="content-block post-medium mb--20">
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="blog_assets/images/small-images/blog-sm-02.jpg" alt="Post Images">
                                            </a>
                                        </div>
                                        <div class="post-content">
                                    ...
                                    <div class="content-block post-medium mb--20">
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="blog_assets/images/small-images/blog-sm-03.jpg" alt="Post Images">
                                            </a>
                                        </div>
                                        <div class="post-content">
                            ...
                            <div class="axil-single-widget widget widget_instagram mb--30">
                                ...
                                <ul class="instagram-post-list-wrapper">
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="blog_assets/images/small-images/instagram-01.jpg" alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="blog_assets/images/small-images/instagram-02.jpg" alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="blog_assets/images/small-images/instagram-03.jpg" alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="blog_assets/images/small-images/instagram-04.jpg" alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="blog_assets/images/small-images/instagram-05.jpg" alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="blog_assets/images/small-images/instagram-06.jpg" alt="Instagram Images">
                                        </a>
                                    </li>
                                </ul>
                                <!-- End Post List  -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-md-6 col-12">
                        ...
                        <div class="content-block post-default image-rounded mt--30">
                            <div class="post-thumbnail">
                                <a href="post-details.html">
                                    <img src="blog_assets/images/post-images/post-dark-01.jpg" alt="Post Images">
                                </a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="content-block post-default image-rounded mt--30">
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="blog_assets/images/post-images/post-dark-04.jpg" alt="Post Images">
                                        </a>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="content-block post-default  image-rounded mt--30">
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="blog_assets/images/post-images/post-dark-03.jpg" alt="Post Images">
                                        </a>
                                        <a class="video-popup size-medium position-top-center" href="post-details.html"><span class="play-icon"></span></a>
                                    </div>
                                    <div class="post-content">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="content-block post-default image-rounded mt--30">
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="blog_assets/images/post-images/post-dark-05.jpg" alt="Post Images">
                                        </a>
                                        <a class="video-popup size-medium position-top-center" href="post-details.html"><span class="play-icon"></span></a>
                                    </div>
                                    <div class="post-content">
                    ...
                    <div class="col-lg-12">
                        <ul class="instagram-post-list">
                            <li class="single-post">
                                <a href="#">
                                    <img src="blog_assets/images/small-images/instagram-md-01.jpg" alt="Instagram Images">
                                    <span class="instagram-button"><i class="fab fa-instagram"></i></span>
                                </a>
                            </li>
                            <li class="single-post">
                                <a href="#">
                                    <img src="blog_assets/images/small-images/instagram-md-02.jpg" alt="Instagram Images">
                                    <span class="instagram-button"><i class="fab fa-instagram"></i></span>
                                </a>
                            </li>
                            <li class="single-post">
                                <a href="#">
                                    <img src="blog_assets/images/small-images/instagram-md-03.jpg" alt="Instagram Images">
                                    <span class="instagram-button"><i class="fab fa-instagram"></i></span>
                                </a>
                            </li>
                            <li class="single-post">
                                <a href="#">
                                    <img src="blog_assets/images/small-images/instagram-md-04.jpg" alt="Instagram Images">
                                    <span class="instagram-button"><i class="fab fa-instagram"></i></span>
                                </a>
                            </li>
                            <li class="single-post">
                                <a href="#">
                                    <img src="blog_assets/images/small-images/instagram-md-05.jpg" alt="Instagram Images">
                                    <span class="instagram-button"><i class="fab fa-instagram"></i></span>
                                </a>
                            </li>
                            <li class="single-post">
                                <a href="#">
                                    <img src="blog_assets/images/small-images/instagram-md-06.jpg" alt="Instagram Images">
                                    <span class="instagram-button"><i class="fab fa-instagram"></i></span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="logo">
                                <a href="index.html">
                                    <img class="dark-logo" src="blog_assets/images/logo/logo-black.png" alt="Logo Images">
                                    <img class="white-logo" src="blog_assets/images/logo/logo-white2.png" alt="Logo Images">
                                </a>
                            </div>
                        </div>
...
============================================ -->
    <!-- Modernizer JS -->
    <script src="{{asset('blog_assets/js/vendor/modernizr.min.js')}}"></script>
    <!-- jQuery JS -->
    <script src="{{asset('blog_assets/js/vendor/jquery.js')}}"></script>
    <!-- Bootstrap JS -->
    <script src="{{asset('blog_assets/js/vendor/bootstrap.min.js')}}"></script>
    <script src="{{asset('blog_assets/js/vendor/slick.min.js')}}"></script>
    <script src="{{asset('blog_assets/js/vendor/tweenmax.min.js')}}"></script>
    <script src="{{asset('blog_assets/js/vendor/js.cookie.js')}}"></script>
    <script src="{{asset('blog_assets/js/vendor/jquery.style.switcher.js')}}"></script>
...
<!-- Mirrored from new.axilthemes.com/demo/template/blogar/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Oct 2023 13:58:45 GMT -->
</html>