...
<head>
    ...
    <meta charset="utf-8" />
    <title>Starter | {{env('APP_NAME')}} - {{env('APP_DESCRIPTION')}}</title>
        ...
        <div class="app-menu navbar-menu">
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url ('admin/home')}}" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                                <i class="mdi mdi-apps"></i> <span data-key="t-dashboards">Dashboards</span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url ('admin/categories')}}">
                                <i class="mdi mdi-cards"></i> <span data-key="t-categories">Category</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url ('admin/blogposts')}}">
                                <i class="mdi mdi-chess-king"></i> <span data-key="t-blogposts">Blogpost</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url ('admin/breakingnews')}}">
                                <i class="mdi mdi-airballoon-outline"></i> <span data-key="t-breakingnews">BreakingNew</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url ('admin/newsletters')}}">
                                <i class="mdi mdi-badge-account-horizontal-outline"></i> <span data-key="t-newsletters">Newsletter</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url ('admin/users')}}">
                                <i class="mdi mdi-account-supervisor"></i> <span data-key="t-users">User</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url ('admin/logout')}}" onclick ="event.preventDefault(); document.getElementById('logout-form').submit();">
                                ...
                                <form action="{{url ('admin/logout')}}" id="logout-form" method="POST">@csrf</form>
                            </a>
                        </li>
